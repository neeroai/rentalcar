...
export const vehicles: Vehicle[] = [
  ...
  makeVehicle({
    ...
    features: ['Tri-zone climate', 'Sliding doors', 'USB in all rows', 'Ample cargo space'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    rating: 4.94,
    tripsCount: 83,
    deliveryOptions: [deliveryOptions.mco, deliveryOptions.universal, deliveryOptions.brickell],
    airportPickup: true,
    instantBook: false,
  ...
  makeVehicle({
    ...
    images: categoryImages.convertible,
    host: hosts[0],
    badges: [l('Look aventurero', 'Adventure-ready'), l('Top off ready', 'Open-air ready')],
    features: ['Removable roof panels', 'All-terrain drive', 'Large cargo opening', 'Rear camera'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    features: ['Glass roof', 'Autopilot', 'Supercharger access', 'Minimal cabin'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    features: ['Leather interior', 'Navigation', 'Quiet cabin', 'Business-class comfort'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    rating: 4.97,
    tripsCount: 58,
    deliveryOptions: [deliveryOptions.mco, deliveryOptions.disney, deliveryOptions.brickell],
    airportPickup: true,
    instantBook: false,
    images: categoryImages.luxury,
    host: hosts[1],
    ...
    features: ['Captain seats', 'Premium surround audio', 'Massive luggage room', '360 camera'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    images: categoryImages.suv,
    host: hosts[2],
    badges: [l('SUV grande', 'Large SUV'), l('Ideal para grupos', 'Great for groups')],
    features: [
      'Full-size cabin',
  ...
  makeVehicle({
    ...
    host: hosts[0],
    badges: [l('Mejor precio', 'Best value'), l('Muy eficiente', 'Fuel efficient')],
    features: ['Rear camera', 'Apple CarPlay', 'Great fuel economy', 'Easy parking'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    features: ['Wireless charging', 'Lane assist', 'Digital cluster', 'Comfortable rear seat'],
    highlights: [
      l(
    ...
    reviews: [
      ...
      },
      {
        ...
        date: '2026-01-11',
        rating: 4.8,
        comment: l('Smooth ride and very easy pickup.', 'Smooth ride and very easy pickup.'),
      },
    ],
  }),
  makeVehicle({
    ...
    images: categoryImages.business,
    host: hosts[1],
    badges: [l('Business class', 'Business class'), l('Quiet arrival', 'Quiet arrival')],
    features: ['Ambient lighting', 'Premium seat package', 'Navigation', 'Driver assistance'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    images: categoryImages.van,
    host: hosts[2],
    badges: [l('Viaje familiar premium', 'Premium family trip'), l('Híbrida', 'Hybrid efficiency')],
    features: ['Stow n Go seating', 'Hybrid economy', 'Rear entertainment', 'Large trunk'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    images: categoryImages.luxury,
    host: hosts[1],
    badges: [l('Sport luxury', 'Sport luxury'), l('Fin de semana premium', 'Premium weekend')],
    features: ['Sport chrono', 'Premium leather', 'Bose audio', 'Performance handling'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    features: ['Captain seats', 'Panoramic roof', 'Hybrid efficiency', 'Premium interior'],
    highlights: [
      l(
  ...
  makeVehicle({
    ...
    features: ['Convertible roof', 'Compact footprint', 'Premium audio', 'Sport mode'],
    highlights: [
      l(
    ...
    intro: l('Pequeño, premium y claramente distinto.', 'Small, premium and clearly distinct.'),
    reviews: [
      {
        id: 'r31',
        author: 'Elena S.',
        date: '2026-02-04',
        rating: 4.9,
        comment: l('Muy divertido y con mucho estilo.', 'Very fun and full of style.'),
      },
      {
        id: 'r32',
        author: 'Patrick D.',
  ...
  makeVehicle({
    ...
    features: ['Safety shield', 'Panoramic roof', 'Easy cargo access', 'Smooth ride'],
    highlights: [
      l(
...
export const pickupOptions = [
  ...
  { value: 'universal', label: l('International Drive', 'International Drive') },
